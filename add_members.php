            ...
            <form action="">
                ...
                <div class="forms-grid">
                    ...
                    <div class="forms">
                        ...
                        <input type="text" placeholder="Enter your house address" name="houseaddress">
                    </div>
                    <div class="forms">
                        <label>Digital Address:</label>
                        <input type="text" placeholder="Enter your digital address" name="digitaladdress">
                    </div>
                    <div class="forms">
                        <label>Contact Number:</label>
                        <input type="text" placeholder="Enter your contact number" name="contactaddress">
                    </div>
                    <div class="forms">
                        <label>Emergency Number:</label>
                        <input type="text" placeholder="Enter your emergency number" name="emergencyaddress">
                    </div>
                    <div class="forms">
                    ...
                    <div class="forms">
                        ...
                        <input type="text" placeholder="Enter your date of birth" name="dateofbirth">
                    </div>
                    <div class="forms">
                        <label>Gender:</label>
                    ...
                    <div class="forms">
                        ...
                        <select name="martialstatus" id="martialstatus" title="martialstatus">
                    ...
                    <div class="forms">
                        ...
                        <input type="text" placeholder="Enter your number of children" name="numberofchildren">
                    </div>
                    <div class="forms">
                    ...
                    <div class="forms">
                        ...
                        <input type="text" placeholder="Enter your name of your mother" name="nameyourmother">
                    </div>
                    <div class="forms">
                        <label>Mother's Denomination:</label>
                        <input type="text" placeholder="Enter your mother's denomination" name="mothersdenomination">
                    </div>
                    <div class="forms">
                        <label>Name of your Father:</label>
                        <input type="text" placeholder="Enter your name of your father" name="nameyourfather">
                    </div>
                    <div class="forms">
                        <label>Father's Denomination:</label>
                        <input type="text" placeholder="Enter your father's denomination" name="fathersdenomination">
                    </div>
                </div>
        ...
        <div class="all">
            ...
            <div class="forms-grid">
                <div class="forms">
                    ...
                    <input type="text" placeholder="Enter your place of employment" name="placeofemployment">
                </div>
                <div class="forms">
        ...
        <div class="all">
            ...
            <div class="forms-grid">
                ...
                <div class="forms">
                    ...
                    <input type="text" placeholder="Enter your your last / current school" name="nameofyourschoool">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="all">
            ...
            <div class="forms-grid">
                ...
                <div class="forms">
                    ...
                    <input type="text" placeholder="Enter your place of baptism" name="placeofbaptism">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="all">
            ...
            <div class="forms-grid">
                ...
                <div class="forms">
                    ...
                    <input type="text" placeholder="Enter your place of confirmation" name="placeofconfirmation">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="all">
            ...
            <div class="forms-grid">
                <div class="forms">
                    ...
                    <select name="selected-societies" class="js-example-basic-multiple" multiple="multiple">
